...
public class ATMOperations {
 	...
 	public static void resetUserAttempts(IATMService operatorCard) {
      	...
      	try {
          	...
          	card.resetPin(); // Resetting PIN attempts for the specified card
 	...
 	public static void main(String[] args) throws NotAOperatorException {
    	...
    	dataBase.put(123456789L, new HDFCDebitCard(123456789L, "Revanth", 710000.0, 141125));
               	 ...
               	 System.out.println("===================================================");
                    	...
                    	try {
                         	...
                         	case 2:
                         	 	...
                         	 	card.depositeAmount(depositAmount); // Deposit amount
                         	 	ACTIVITY.add("Accessed By " + card.getUserName() + " Activity: Amount Deposited "
                                       	+ depositAmount + " in the Machine");
                              	break;
                         	case 3:
                         	 	System.out.println("Your Account Balance is: " + card.checkBalance()); // Check
                                       	                                       	                                       	// balance
